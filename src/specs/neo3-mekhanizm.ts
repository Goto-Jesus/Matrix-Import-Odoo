...
export const neo3Boms: BomDef[] = [
...

  {
    ...
    components: [
      { product: '[ДСП]', variants: ['Звичайний'], qty: 0.59, uomId: UOM.M2, operationIndex: 0 },
      { product: '[ДВП]', variants: ['Звичайний'], qty: 0.41, uomId: UOM.M2, operationIndex: 0 },
    ],
  },
...

  {
    ...
    components: [
      { product: '[ДСП]', variants: ['Звичайний'], qty: 1.76, uomId: UOM.M2, operationIndex: 0 },
      { product: '[ДВП]', variants: ['Білий'],     qty: 0.73, uomId: UOM.M2, operationIndex: 0 },
    ],
  },
...

  {
    ...
    components: [
      { product: '🧩[Ламінат - лист]', variants: ['712x220'],          qty: 2, uomId: UOM.UNITS, operationIndex: 0 },
      { product: '🧩[Ламінат - лист]', variants: ['950х220'],          qty: 1, uomId: UOM.UNITS, operationIndex: 0 },
      // "950х220 с углами" — якщо [WARN], треба додати значення атрибуту "Ламінат Розмір" в Odoo
      { product: '🧩[Ламінат - лист]', variants: ['950х220 с углами'], qty: 1, uomId: UOM.UNITS, operationIndex: 0 },
    ],
  },
...

  {
    ...
    components: [
      { product: '🧩[Бильце - нарізані деталі]', variants: ['Б.Нео'], qty: 1, uomId: UOM.UNITS, operationIndex: 0 },
    ],
  },
...

  {
    ...
    components: [
      { product: '🧩[Каркас - нарізані деталі]',   variants: ['100ДСП Механізм'], qty: 1, uomId: UOM.UNITS, operationIndex: 0 },
      { product: '🪵[Каркас - нарізана деревина]', variants: ['100ДСП Механізм'], qty: 1, uomId: UOM.UNITS, operationIndex: 0 },
      { product: '🧩[Ламінат - нарізані деталі]',  variants: ['100 Механізм'],    qty: 1, uomId: UOM.UNITS, operationIndex: 0 },
    ],
  },
...

  {
    ...
    components: [
      { product: '[Поролон]', variants: ['ST-2535 (2000x1600x20)'],     qty: 2.4,  uomId: UOM.KG, operationIndex: 0 },
      { product: '[Поролон]', variants: ['ST-2233 (2000x1600x40x105)'], qty: 1.4,  uomId: UOM.KG, operationIndex: 0 },
      { product: '[Поролон]', variants: ['ST-2233 (2000x1600x10)'],     qty: 1.06, uomId: UOM.KG, operationIndex: 0 },
      { product: '[Поролон]', variants: ['ST-2233 (2000x1400x10)'],     qty: 0.93, uomId: UOM.KG, operationIndex: 0 },
      { product: '[Поролон]', variants: ['ST-2233 (2000x1600x40x70)'],  qty: 1.6,  uomId: UOM.KG, operationIndex: 0 },
      { product: '[Войлок]',  variants: ['1.60'],                        qty: 3,    uomId: UOM.M,  operationIndex: 0 },
    ],
  },
  ...
  // ЦЕХ №5 — Порізка Поролону (ПОСИЛЕНИЙ блок)
  {
    ...
    components: [
      ...
      { product: '[Поролон]', variants: ['ST-2233 (2000x1600x10)'],     qty: 1.06, uomId: UOM.KG, operationIndex: 0 },
      { product: '[Поролон]', variants: ['ST-2233 (2000x1400x10)'],     qty: 0.93, uomId: UOM.KG, operationIndex: 0 },
      { product: '[Поролон]', variants: ['ST-2233 (2000x1600x40x70)'],  qty: 3.2,  uomId: UOM.KG, operationIndex: 0 }, // x2
      { product: '[Войлок]',  variants: ['1.60'],                        qty: 6,    uomId: UOM.M,  operationIndex: 0 }, // x2
    ],
  },
...

  {
    ...
    components: [
      { product: '[Флізелін]', variants: ['30'], qty: 1.3, uomId: UOM.M, operationIndex: 0 },
    ],
  },
...

  {
    ...
    components: [
      { product: '🪤[Каркас - напівфабрикат]',       variants: ['100ДСП Механізм'],  qty: 3, uomId: UOM.UNITS, operationIndex: 0 },
      { product: '🪤[Бильце - напівфабрикат]',       variants: ['Б.Нео'],            qty: 2, uomId: UOM.UNITS, operationIndex: 0 },
      { product: '🧩[Поролон - нарізані компонети]', variants: ['Д.Нео-3 Механізм'], qty: 1, uomId: UOM.UNITS, operationIndex: 0 },
      { product: '[Боннель]',                         variants: ['910 х 600'],         qty: 3, uomId: UOM.UNITS, operationIndex: 0 },
      { product: '[Боннель]',                         variants: ['910 х 750'],         qty: 3, uomId: UOM.UNITS, operationIndex: 0 },
    ],
  },
  ...
  // ЦЕХ №6 — Поклейка Поролону + Збивка (ПОСИЛЕНИЙ блок)
  {
    ...
    components: [
      { product: '🪤[Каркас - напівфабрикат]',       variants: ['100ДСП Механізм'],           qty: 3, uomId: UOM.UNITS, operationIndex: 0 },
      { product: '🪤[Бильце - напівфабрикат]',       variants: ['Б.Нео'],                     qty: 2, uomId: UOM.UNITS, operationIndex: 0 },
      { product: '🧩[Поролон - нарізані компонети]', variants: ['Д.Нео-3 Механізм, посилений блок'], qty: 1, uomId: UOM.UNITS, operationIndex: 0 },
      { product: '[Боннель]',                         variants: ['910 х 600'],                  qty: 3, uomId: UOM.UNITS, operationIndex: 0 },
      { product: '[Боннель]',                         variants: ['910 х 750'],                  qty: 3, uomId: UOM.UNITS, operationIndex: 0 },
    ],
  },
...

  {
    ...
    components: [
      { product: '[Синтепон]', variants: ['400'],    qty: 14,   uomId: UOM.M, operationIndex: 0 },
      { product: '[Тканина]',  variants: ['Рене 4'], qty: 17.5, uomId: UOM.M, operationIndex: 0 },
      { product: '[Флізелін]', variants: ['60'],     qty: 16.5, uomId: UOM.M, operationIndex: 0 },
    ],
  },
  ...
  {
    product: '🧩[Чохол - нарізані матеріали]',
    variants: ['Д.Нео-3 Механізм, зменшене бильце', 'Рене 4'],
    reference: 'Д.Нео-3 Механізм, зменшене бильце / Рене 4',
    operations: [{
      name: 'Операція (Цех №7) 🧩[Чохол - нарізані матеріали] (Д.Нео-3 Механізм, зменшене бильце / Рене 4)',
      workcenter: WC.C7,
      priceRate: 500,
    }],
    components: [
...

  {
    ...
    components: [
      { product: '🧩[Чохол - нарізані матеріали]', variants: ['Д.Нео-3 Механізм', 'Рене 4'], qty: 1, uomId: UOM.UNITS, operationIndex: 0 },
    ],
  },
  ...
  // ЦЕХ №8 — Швейка (Зменшені Бильця)
  {
    ...
    reference: 'Д.Нео-3 Механізм, зменшене бильце / Рене 4',
    operations: [{
      name: 'Операція (Цех №8) 🪤[Чохол - напівфабрикат] (Д.Нео-3 Механізм, зменшене бильце / Рене 4)',
      workcenter: WC.C8,
    }],
    components: [
      { product: '🧩[Чохол - нарізані матеріали]', variants: ['Д.Нео-3 Механізм, зменшене бильце', 'Рене 4'], qty: 1, uomId: UOM.UNITS, operationIndex: 0 },
    ],
  },
...

  {
    ...
    components: [
      { product: '[Наволочка]', variants: ['Д.Нео'], qty: 2,   uomId: UOM.UNITS, operationIndex: 0 },
...

  {
    ...
    components: [
      ...
      { product: '🪤🧽[Каркас + Поролон - напівфабрикат 2]', variants: ['Д.Нео-3 Механізм'],      qty: 1,  uomId: UOM.UNITS, operationIndex: 0 },
      { product: 'Тік-так',                                                                          qty: 3,  uomId: UOM.UNITS, operationIndex: 0 },
      { product: 'Распорка',                                                                          qty: 3,  uomId: UOM.UNITS, operationIndex: 0 },
      { product: '[Соединитель]', variants: ['83 эконом'],                                            qty: 8,  uomId: UOM.UNITS, operationIndex: 0 },
      // Точна назва значення атрибуту [Петля]: "K 113.01" (перевірте в Odoo)
      { product: '[Петля]',       variants: ['K 113.01'],                                             qty: 6,  uomId: UOM.UNITS, operationIndex: 0 },
      { product: '[Ніжка]',       variants: ['h30'],                                                  qty: 26, uomId: UOM.UNITS, operationIndex: 0 },
      { product: '🪤[Чохол - напівфабрикат]', variants: ['Д.Нео-3 Механізм', 'Рене 4'],             qty: 1,  uomId: UOM.UNITS, operationIndex: 0 },
      // [Подушка] потребує 3-го атрибуту "Наповнювач" на шаблоні
      { product: '[Подушка]',     variants: ['Д.Нео', 'Рене 4', 'Крихта ППУ'],                       qty: 3,  uomId: UOM.UNITS, operationIndex: 0 },
