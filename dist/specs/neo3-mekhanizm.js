...
exports.neo3Boms = [
    ...
    // ═══════════════════════════════════════════════════════════
    {
        ...
        components: [
            { product: "Дерево", qty: 0.02, uomId: types_1.UOM.M3, operationIndex: 0 },
        ],
    },
    {
        ...
        components: [
            { product: "Дерево", qty: 0.00125, uomId: types_1.UOM.M3, operationIndex: 0 },
        ],
    },
    // ═══════════════════════════════════════════════════════════
    ...
    // УВАГА: [Подушка] потребує 3-го атрибуту "Наповнювач" (Крихта ППУ / Холлофайбер)
    // ═══════════════════════════════════════════════════════════
    {
        product: "[Подушка]",
        ...
        components: [
            ...
            { product: "Крихта ППУ", qty: 2.7, uomId: types_1.UOM.KG, operationIndex: 0 },
        ],
    },
    {
        product: "[Подушка]",
        variants: ["Д.Нео", "Рене 4", "Холлофайбер"],
        reference: "Д.Нео / Рене 4 / Холлофайбер",
        operations: [
            {
                name: "Операція (Цех №9-1) [Подушка] (Д.Нео / Рене 4 / Холлофайбер)",
                workcenter: WC.C91,
            },
        ],
        components: [
            ...
            { product: "Холлофайбер", qty: 2.7, uomId: types_1.UOM.KG, operationIndex: 0 },
        ],
    },
    // ═══════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════
    {
        ...
        components: [
            ...
            { product: "Тік-так", qty: 3, uomId: types_1.UOM.UNITS, operationIndex: 0 },
            { product: "Распорка", qty: 3, uomId: types_1.UOM.UNITS, operationIndex: 0 },
            {
            ...
            { product: "Скотч", qty: 85, uomId: types_1.UOM.M, operationIndex: 1 },
            { product: "Плівка", qty: 3.4, uomId: types_1.UOM.KG, operationIndex: 1 },
            { product: "Картон", qty: 5.1, uomId: types_1.UOM.M, operationIndex: 1 },
