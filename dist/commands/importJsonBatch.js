...
const batchImporter_1 = require("../tools/importJson/batchImporter");
const resolver_1 = require("../tools/importJson/resolver");
...
async function run() {
    ...
    await (0, batchImporter_1.batchImportAllBoms)(data.boms, data.sourceFile);
}
run().catch((err) => {
